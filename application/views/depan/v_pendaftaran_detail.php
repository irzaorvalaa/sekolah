        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="blog-tiltle_block">
                    <h4><a href="<?php echo site_url('pendaftaran-detail/'.$slug);?>"><?php echo $title;?></a></h4>
                    <h6> <a href="#"><i class="fa fa-user" aria-hidden="true"></i><span><?php echo $author;?></span> </a></span></a></h6>
            ...
            <div class="col-md-4">
              <form action="<?php echo site_url('blog/search');?>" method="get"  style="margin-bottom: 3rem;">
                ...
                <div class="blog-featured_post">
                  ...
                  <?php foreach ($populer->result() as $row) :?>
                    <div class="blog-featured-img_block">
                        <img width="35%" src="<?php echo base_url().'assets/images/'.$row->pendaftaran_gambar;?>" class="img-fluid" alt="blog-featured-img">
                        <h5><a href="<?php echo site_url('pendaftaran-detail/'.$row->pendaftaran_slug);?>"><?php echo limit_words($row->pendaftaran_judul,3).'...';?></a></h5>
                        <p><?php echo limit_words($row->pendaftaran_isi,5).'...';?></p>
                    </div>
                    <hr>
                  <?php endforeach;?>
                </div>
